package me.martinitslinda.blockprotect.protocol.v1_11;
...
public class Protocol_v1_11_R1 implements Protocol{
    ...
    public boolean setBlock(final World world, final int x, final int y, final int z, final int blockId, final byte data){
        ...
        final net.minecraft.server.v1_11_R1.World craftWorld = ((CraftWorld)world).getHandle();
        final net.minecraft.server.v1_11_R1.Chunk craftChunk = craftWorld.getChunkAt(x >> 4, z >> 4);
